...
import { View, Text, SafeAreaView, StatusBar, TextInput, TouchableOpacity, Modal, Animated, ScrollView, Alert } from 'react-native'
...
const SurveyScreen = () => {
    ...
    const validateAnswer = (selectedOption) => {
        ...
        if (selectedOption == correct_option) {
            ...
            // add data
            setFinalSymptoms(finalSymptoms.concat([selectedOption]))
        ...
        return (
            <View>
                <TextInput
                    ...
                    onChange={(e) => {
                        if(e.nativeEvent.text === "" || !e.nativeEvent.text)  <Alert>Please enter user name/email</Alert>
